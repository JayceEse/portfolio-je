...
const About = () => {
  return (
    ...
    <div className='about__content_container'>
      <h1>About Me</h1>
      <p>Hello there! My name is Jayce Ese and I am a self-taught Front-End Developer as well as a full-time stay-at-home dad to my wonderful two-year-old daughter. Although I may joke that she's sometimes a "gremlin," she truly is a joy to be around most of the time!</p>
      ...
      <p>Prior to my foray into web development, I gained valuable experience in communication and collaboration through various customer service and sales roles.</p>
