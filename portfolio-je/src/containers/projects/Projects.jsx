      ...
      <div className="projects__container">
        <div className="projects__content">
          ...
          <div className="projects__content_info">
            ...
            <ul>
              ...
              <li>
                <FontAwesomeIcon icon={faCss3} id="css" />
              </li>
            </ul>
          </div>
        </div>
        <div className="projects__content">
          ...
          <div className="projects__content_info">
            ...
            <p>
              Created Pokemon Stats using React JS, CSS3, JavaScript & Pokemon
        ...
        <div className="projects__content">
          ...
          <div className="projects__content_info">
            ...
            <p>
              ...
              Vite JS, CSS3 and JavaScript to showcase my web development
